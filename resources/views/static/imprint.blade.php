...
@section('content')
    <div class="mx-20">
        <div class='impressum'><h1 class="text-lg">Impressum</h1>
            ...
            <p><strong>Kontakt:</strong> <br>
                Telefon: XXXXXXXXXXXX <br>
                E-Mail: <a href=''>XXXXXXX@XXXXX.com</a></br>
            </p>
            <p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
                ...
                Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.<br><br><strong>Datenschutz</strong><br><br>
                ...
                Weise und zu dem zuvor benannten Zweck einverstanden.</p><br>
            Website Impressum erstellt durch <a href="https://www.impressum-generator.de">impressum-generator.de</a> von
            der <a href="https://www.kanzlei-hasselbach.de/">Kanzlei Hasselbach</a>
        </div>
