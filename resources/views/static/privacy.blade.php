...
@section('content')
    <div class="mx-20">
        <h4 class="text-lg mt-4 text-primary">Datenschutzerklärung</h4>

        <p class="mt-2">Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders
            hohen Stellenwert für die Geschäftsleitung des TeamSpark Projektes. Eine Nutzung der Internetseiten von TeamSpark
            ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine betroffene Person
            besondere Services unseres Unternehmens über unsere Internetseite in Anspruch nehmen möchte, könnte jedoch
        ...
        <p class="mt-2">Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift,
            E-Mail-Adresse oder Telefonnummer einer betroffenen Person, erfolgt stets im Einklang mit der
            Datenschutz-Grundverordnung und in Übereinstimmung mit den für TeamSpark geltenden
        ...
        <p class="mt-2">Die TeamSpark hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
        ...
        <h4 class="text-lg mt-4 text-primary">1. Begriffsbestimmungen</h4>
        <p class="mt-2">Die Datenschutzerklärung der TeamSpark beruht auf den Begrifflichkeiten, die durch den
            Europäischen Richtlinien- und Verordnungsgeber beim Erlass der Datenschutz-Grundverordnung (DS-GVO)
            verwendet wurden. Unsere Datenschutzerklärung soll sowohl für die Öffentlichkeit als auch für unsere Kunden
            und Geschäftspartner einfach lesbar und verständlich sein. Um dies zu gewährleisten, möchten wir vorab die
            verwendeten Begrifflichkeiten erläutern.</p>

        <p class="mt-2">Wir verwenden in dieser Datenschutzerklärung unter anderem die folgenden Begriffe:</p>

        <ul style="list-style: none">
            <li><h4 class="text-lg mt-4 text-primary">a)    personenbezogene Daten</h4>
                <p class="mt-2">Personenbezogene Daten sind alle Informationen, die sich auf eine identifizierte oder
            ...
            <li><h4 class="text-lg mt-4 text-primary">b)    betroffene Person</h4>
                <p class="mt-2">Betroffene Person ist jede identifizierte oder identifizierbare natürliche Person, deren
                    personenbezogene Daten von dem für die Verarbeitung Verantwortlichen verarbeitet werden.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">c)    Verarbeitung</h4>
                <p class="mt-2">Verarbeitung ist jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang
            ...
            <li><h4 class="text-lg mt-4 text-primary">d)    Einschränkung der Verarbeitung</h4>
                <p class="mt-2">Einschränkung der Verarbeitung ist die Markierung gespeicherter personenbezogener Daten
                    mit dem Ziel, ihre künftige Verarbeitung einzuschränken.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">e)    Profiling</h4>
                <p class="mt-2">Profiling ist jede Art der automatisierten Verarbeitung personenbezogener Daten, die
                    darin besteht, dass diese personenbezogenen Daten verwendet werden, um bestimmte persönliche
            ...
            <li><h4 class="text-lg mt-4 text-primary">f)     Pseudonymisierung</h4>
                <p class="mt-2">Pseudonymisierung ist die Verarbeitung personenbezogener Daten in einer Weise, auf
            ...
            <li><h4 class="text-lg mt-4 text-primary">g)    Verantwortlicher oder für die Verarbeitung
                    Verantwortlicher</h4>
                <p class="mt-2">Verantwortlicher oder für die Verarbeitung Verantwortlicher ist die natürliche oder
                    juristische Person, Behörde, Einrichtung oder andere Stelle, die allein oder gemeinsam mit anderen
                    über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet. Sind die Zwecke
                    und Mittel dieser Verarbeitung durch das Unionsrecht oder das Recht der Mitgliedstaaten vorgegeben,
                    so kann der Verantwortliche beziehungsweise können die bestimmten Kriterien seiner Benennung nach
                    dem Unionsrecht oder dem Recht der Mitgliedstaaten vorgesehen werden.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">h)    Auftragsverarbeiter</h4>
                <p class="mt-2">Auftragsverarbeiter ist eine natürliche oder juristische Person, Behörde, Einrichtung
                    oder andere Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen verarbeitet.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">i)      Empfänger</h4>
                <p class="mt-2">Empfänger ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere
                    Stelle, der personenbezogene Daten offengelegt werden, unabhängig davon, ob es sich bei ihr um einen
                    Dritten handelt oder nicht. Behörden, die im Rahmen eines bestimmten Untersuchungsauftrags nach dem
            ...
            <li><h4 class="text-lg mt-4 text-primary">j)      Dritter</h4>
                <p class="mt-2">Dritter ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere
                    Stelle außer der betroffenen Person, dem Verantwortlichen, dem Auftragsverarbeiter und den Personen,
                    die unter der unmittelbaren Verantwortung des Verantwortlichen oder des Auftragsverarbeiters befugt
                    sind, die personenbezogenen Daten zu verarbeiten.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">k)    Einwilligung</h4>
                <p class="mt-2">Einwilligung ist jede von der betroffenen Person freiwillig für den bestimmten Fall in
        ...
        <h4 class="text-lg mt-4 text-primary">2. Name und Anschrift des für die Verarbeitung Verantwortlichen</h4>
        <p class="mt-2">Verantwortlicher im Sinne der Datenschutz-Grundverordnung, sonstiger in den Mitgliedstaaten der
            Europäischen Union geltenden Datenschutzgesetze und anderer Bestimmungen mit datenschutzrechtlichem
            Charakter ist die:</p>

        <p class="mt-2">Max Mustermann</p>
        <p class="mt-2">Musterstrasse 1</p>
        <p class="mt-2">11111 Musterstadt</p>
        <p class="mt-2">Germany</p>
        <p class="mt-2">Website: www.team-spark.com</p>

        <h4 class="text-lg mt-4 text-primary">3. Cookies</h4>
        <p class="mt-2">Die Internetseiten von TeamSpark verwenden Cookies. Cookies sind Textdateien, welche über
            einen Internetbrowser auf einem Computersystem abgelegt und gespeichert werden.</p>

        <p class="mt-2">Zahlreiche Internetseiten und Server verwenden Cookies. Viele Cookies enthalten eine sogenannte
            Cookie-ID. Eine Cookie-ID ist eine eindeutige Kennung des Cookies. Sie besteht aus einer Zeichenfolge, durch
            welche Internetseiten und Server dem konkreten Internetbrowser zugeordnet werden können, in dem das Cookie
            ...
            bestimmter Internetbrowser kann über die eindeutige Cookie-ID wiedererkannt und identifiziert werden.</p>

        <p class="mt-2">Durch den Einsatz von Cookies kann TeamSpark den Nutzern dieser Internetseite
            nutzerfreundlichere Services bereitstellen, die ohne die Cookie-Setzung nicht möglich wären.</p>

        <p class="mt-2">Mittels eines Cookies können die Informationen und Angebote auf unserer Internetseite im Sinne
            des Benutzers optimiert werden. Cookies ermöglichen uns, wie bereits erwähnt, die Benutzer unserer
            ...
            nicht bei jedem Besuch der Internetseite erneut seine Zugangsdaten eingeben, weil dies von der Internetseite
            und dem auf dem Computersystem des Benutzers abgelegten Cookie übernommen wird. Ein weiteres Beispiel ist
            das Cookie eines Warenkorbes im Online-Shop. Der Online-Shop merkt sich die Artikel, die ein Kunde in den
            virtuellen Warenkorb gelegt hat, über ein Cookie.</p>

        <p class="mt-2">Die betroffene Person kann die Setzung von Cookies durch unsere Internetseite jederzeit mittels
            einer entsprechenden Einstellung des genutzten Internetbrowsers verhindern und damit der Setzung von Cookies
        ...
        <h4 class="text-lg mt-4 text-primary">4. Erfassung von allgemeinen Daten und Informationen</h4>
        <p class="mt-2">Die Internetseite TeamSpark erfasst mit jedem Aufruf der Internetseite durch eine
            ...
            Referrer), (4) die Unterwebseiten, welche über ein zugreifendes System auf unserer Internetseite angesteuert
        ...
        <p class="mt-2">Bei der Nutzung dieser allgemeinen Daten und Informationen zieht TeamSpark keine
            ...
            Daten und Informationen werden durch TeamSpark daher einerseits statistisch und ferner mit dem Ziel
        ...
        <h4 class="text-lg mt-4 text-primary">5. Registrierung auf unserer Internetseite</h4>
        <p class="mt-2">Die betroffene Person hat die Möglichkeit, sich auf der Internetseite des für die Verarbeitung
            ...
            für die Verarbeitung Verantwortlichen zuzurechnen ist, nutzt.</p>

        <p class="mt-2">Durch eine Registrierung auf der Internetseite des für die Verarbeitung Verantwortlichen wird
            ferner die vom Internet-Service-Provider (ISP) der betroffenen Person vergebene IP-Adresse, das Datum sowie
            die Uhrzeit der Registrierung gespeichert. Die Speicherung dieser Daten erfolgt vor dem Hintergrund, dass
            nur so der Missbrauch unserer Dienste verhindert werden kann, und diese Daten im Bedarfsfall ermöglichen,
        ...
        <p class="mt-2">Die Registrierung der betroffenen Person unter freiwilliger Angabe personenbezogener Daten dient
            dem für die Verarbeitung Verantwortlichen dazu, der betroffenen Person Inhalte oder Leistungen anzubieten,
            die aufgrund der Natur der Sache nur registrierten Benutzern angeboten werden können. Registrierten Personen
        ...
        <p class="mt-2">Der für die Verarbeitung Verantwortliche erteilt jeder betroffenen Person jederzeit auf Anfrage
            Auskunft darüber, welche personenbezogenen Daten über die betroffene Person gespeichert sind. Ferner
            berichtigt oder löscht der für die Verarbeitung Verantwortliche personenbezogene Daten auf Wunsch oder
            Hinweis der betroffenen Person, soweit dem keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Die
            Gesamtheit der Mitarbeiter des für die Verarbeitung Verantwortlichen stehen der betroffenen Person in diesem
            Zusammenhang als Ansprechpartner zur Verfügung.</p>

        <h4 class="text-lg mt-4 text-primary">6. Abonnement unseres Newsletters</h4>
        <p class="mt-2">Auf der Internetseite TeamSpark wird den Benutzern die Möglichkeit eingeräumt, den
            Newsletter unseres Unternehmens zu abonnieren. Welche personenbezogenen Daten bei der Bestellung des
            Newsletters an den für die Verarbeitung Verantwortlichen übermittelt werden, ergibt sich aus der hierzu
            verwendeten Eingabemaske.</p>

        <p class="mt-2">TeamSpark informiert ihre Kunden und Geschäftspartner in regelmäßigen Abständen im Wege
            eines Newsletters über Angebote des Unternehmens. Der Newsletter unseres Unternehmens kann von der
            betroffenen Person grundsätzlich nur dann empfangen werden, wenn (1) die betroffene Person über eine gültige
            E-Mail-Adresse verfügt und (2) die betroffene Person sich für den Newsletterversand registriert. An die von
            einer betroffenen Person erstmalig für den Newsletterversand eingetragene E-Mail-Adresse wird aus
            rechtlichen Gründen eine Bestätigungsmail im Double-Opt-In-Verfahren versendet. Diese Bestätigungsmail dient
            der Überprüfung, ob der Inhaber der E-Mail-Adresse als betroffene Person den Empfang des Newsletters
            autorisiert hat.</p>

        <p class="mt-2">Bei der Anmeldung zum Newsletter speichern wir ferner die vom Internet-Service-Provider (ISP)
            vergebene IP-Adresse des von der betroffenen Person zum Zeitpunkt der Anmeldung verwendeten Computersystems
            sowie das Datum und die Uhrzeit der Anmeldung. Die Erhebung dieser Daten ist erforderlich, um den(möglichen)
            Missbrauch der E-Mail-Adresse einer betroffenen Person zu einem späteren Zeitpunkt nachvollziehen zu können
            und dient deshalb der rechtlichen Absicherung des für die Verarbeitung Verantwortlichen.</p>

        <p class="mt-2">Die im Rahmen einer Anmeldung zum Newsletter erhobenen personenbezogenen Daten werden
            ausschließlich zum Versand unseres Newsletters verwendet. Ferner könnten Abonnenten des Newsletters per
            E-Mail informiert werden, sofern dies für den Betrieb des Newsletter-Dienstes oder eine diesbezügliche
            Registrierung erforderlich ist, wie dies im Falle von Änderungen am Newsletterangebot oder bei der
            Veränderung der technischen Gegebenheiten der Fall sein könnte. Es erfolgt keine Weitergabe der im Rahmen
            des Newsletter-Dienstes erhobenen personenbezogenen Daten an Dritte. Das Abonnement unseres Newsletters kann
            durch die betroffene Person jederzeit gekündigt werden. Die Einwilligung in die Speicherung
            personenbezogener Daten, die die betroffene Person uns für den Newsletterversand erteilt hat, kann jederzeit
            widerrufen werden. Zum Zwecke des Widerrufs der Einwilligung findet sich in jedem Newsletter ein
            entsprechender Link. Ferner besteht die Möglichkeit, sich jederzeit auch direkt auf der Internetseite des
            für die Verarbeitung Verantwortlichen vom Newsletterversand abzumelden oder dies dem für die Verarbeitung
            Verantwortlichen auf andere Weise mitzuteilen.</p>

        <h4 class="text-lg mt-4 text-primary">7. Newsletter-Tracking</h4>
        <p class="mt-2">Die Newsletter von TeamSpark enthalten sogenannte Zählpixel. Ein Zählpixel ist eine
            Miniaturgrafik, die in solche E-Mails eingebettet wird, welche im HTML-Format versendet werden, um eine
            Logdatei-Aufzeichnung und eine Logdatei-Analyse zu ermöglichen. Dadurch kann eine statistische Auswertung
            des Erfolges oder Misserfolges von Online-Marketing-Kampagnen durchgeführt werden. Anhand des eingebetteten
            Zählpixels kann Teamspark erkennen, ob und wann eine E-Mail von einer betroffenen Person geöffnet
            wurde und welche in der E-Mail befindlichen Links von der betroffenen Person aufgerufen wurden.</p>

        <p class="mt-2">Solche über die in den Newslettern enthaltenen Zählpixel erhobenen personenbezogenen Daten,
            werden von dem für die Verarbeitung Verantwortlichen gespeichert und ausgewertet, um den Newsletterversand
            zu optimieren und den Inhalt zukünftiger Newsletter noch besser den Interessen der betroffenen Person
            anzupassen. Diese personenbezogenen Daten werden nicht an Dritte weitergegeben. Betroffene Personen sind
            jederzeit berechtigt, die diesbezügliche gesonderte, über das Double-Opt-In-Verfahren abgegebene
            Einwilligungserklärung zu widerrufen. Nach einem Widerruf werden diese personenbezogenen Daten von dem für
            die Verarbeitung Verantwortlichen gelöscht. Eine Abmeldung vom Erhalt des Newsletters deutet TeamSpark
            automatisch als Widerruf.</p>

        <h4 class="text-lg mt-4 text-primary">8. Routinemäßige Löschung und Sperrung von personenbezogenen Daten</h4>
        <p class="mt-2">Der für die Verarbeitung Verantwortliche verarbeitet und speichert personenbezogene Daten der
        ...
        <p class="mt-2">Entfällt der Speicherungszweck oder läuft eine vom Europäischen Richtlinien- und
        ...
        <h4 class="text-lg mt-4 text-primary">9. Rechte der betroffenen Person</h4>
        <ul style="list-style: none;">
            <li><h4 class="text-lg mt-4 text-primary">a)    Recht auf Bestätigung</h4>
                <p class="mt-2">Jede betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
                    eingeräumte Recht, von dem für die Verarbeitung Verantwortlichen eine Bestätigung darüber zu
                    verlangen, ob sie betreffende personenbezogene Daten verarbeitet werden. Möchte eine betroffene
                    Person dieses Bestätigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an einen
                    Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">b)    Recht auf Auskunft</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                ...
                <p class="mt-2">Ferner steht der betroffenen Person ein Auskunftsrecht darüber zu, ob personenbezogene
                    Daten an ein Drittland oder an eine internationale Organisation übermittelt wurden. Sofern dies der
                    Fall ist, so steht der betroffenen Person im Übrigen das Recht zu, Auskunft über die geeigneten
                    Garantien im Zusammenhang mit der Übermittlung zu erhalten.</p>

                <p class="mt-2">Möchte eine betroffene Person dieses Auskunftsrecht in Anspruch nehmen, kann sie sich
                    hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">c)    Recht auf Berichtigung</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                    Europäischen Richtlinien- und Verordnungsgeber gewährte Recht, die unverzügliche Berichtigung sie
                    betreffender unrichtiger personenbezogener Daten zu verlangen. Ferner steht der betroffenen Person
                ...
                <p class="mt-2">Möchte eine betroffene Person dieses Berichtigungsrecht in Anspruch nehmen, kann sie
                    sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.</p>
            </li>
            <li>
                <h4 class="text-lg mt-4 text-primary">d)    Recht auf Löschung (Recht auf Vergessen werden)</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                    Europäischen Richtlinien- und Verordnungsgeber gewährte Recht, von dem Verantwortlichen zu
                    verlangen, dass die sie betreffenden personenbezogenen Daten unverzüglich gelöscht werden, sofern
                    einer der folgenden Gründe zutrifft und soweit die Verarbeitung nicht erforderlich ist:</p>
                ...
                <p class="mt-2">Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung
                    von personenbezogenen Daten, die bei TeamSpark gespeichert sind, veranlassen möchte, kann
                    sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. TeamSpark
                    wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
                    wird.</p>

                <p class="mt-2">Wurden die personenbezogenen Daten von TeamSpark öffentlich gemacht und ist
                    unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
                    personenbezogenen Daten verpflichtet, so trifft TeamSpark unter Berücksichtigung der
                    verfügbaren Technologie und der Implementierungskosten angemessene Maßnahmen, auch technischer Art,
                    um andere für die Datenverarbeitung Verantwortliche, welche die veröffentlichten personenbezogenen
                    Daten verarbeiten, darüber in Kenntnis zu setzen, dass die betroffene Person von diesen anderen für
                    ...
                    Verarbeitung nicht erforderlich ist.TeamSpark wird im Einzelfall das
                    Notwendige veranlassen.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">e)    Recht auf Einschränkung der Verarbeitung</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                ...
                <p class="mt-2">Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person
                    die Einschränkung von personenbezogenen Daten, die bei TeamSpark gespeichert sind,
                    verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
                    Verantwortlichen wenden. TeamSpark wird die Einschränkung der Verarbeitung
                    veranlassen.</p>
            </li>
            <li><h4 class="text-lg mt-4 text-primary">f)     Recht auf Datenübertragbarkeit</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                    Europäischen Richtlinien- und Verordnungsgeber gewährte Recht, die sie betreffenden
                    personenbezogenen Daten, welche durch die betroffene Person einem Verantwortlichen bereitgestellt
                    wurden, in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten. Sie hat außerdem
                    das Recht, diese Daten einem anderen Verantwortlichen ohne Behinderung durch den Verantwortlichen,
                    dem die personenbezogenen Daten bereitgestellt wurden, zu übermitteln, sofern die Verarbeitung auf
                    der Einwilligung gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO oder
                ...
                <p class="mt-2">Ferner hat die betroffene Person bei der Ausübung ihres Rechts auf Datenübertragbarkeit
                    gemäß Art. 20 Abs. 1 DS-GVO das Recht, zu erwirken, dass die personenbezogenen Daten direkt von
                    einem Verantwortlichen an einen anderen Verantwortlichen übermittelt werden, soweit dies technisch
                    machbar ist und sofern hiervon nicht die Rechte und Freiheiten anderer Personen beeinträchtigt
                    werden.</p>

                <p class="mt-2">Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person
                    jederzeit an TeamSpark wenden.</p>

            </li>
            <li>
                <h4 class="text-lg mt-4 text-primary">g)    Recht auf Widerspruch</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                    ...
                    Daten, die aufgrund von Art. 6 Abs. 1 Buchstaben e oder f DS-GVO erfolgt, Widerspruch einzulegen.
                    Dies gilt auch für ein auf diese Bestimmungen gestütztes Profiling.</p>

                <p class="mt-2">TeamSpark verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
                    nicht mehr, es sei denn, wir können zwingende schutzwürdige Gründe für die Verarbeitung nachweisen,
                    die den Interessen, Rechten und Freiheiten der betroffenen Person überwiegen, oder die Verarbeitung
                    dient der Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen.</p>

                <p class="mt-2">Verarbeitet TeamSpark personenbezogene Daten, um Direktwerbung zu betreiben, so
                    ...
                    gegenüber TeamSpark der Verarbeitung für Zwecke der Direktwerbung, so wird TeamSpark
                    die personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten.</p>

                <p class="mt-2">Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen
                    Situation ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei Teamspark
                ...
                <p class="mt-2">Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an Teamspark
                    oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht
            ...
            <li><h4 class="text-lg mt-4 text-primary">h)    Automatisierte Entscheidungen im Einzelfall einschließlich
                    Profiling</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                    ...
                    und Freiheiten sowie der berechtigten Interessen der betroffenen Person enthalten oder (3) mit
                    ausdrücklicher Einwilligung der betroffenen Person erfolgt.</p>

                <p class="mt-2">Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen
                    der betroffenen Person und dem Verantwortlichen erforderlich oder (2) erfolgt sie mit ausdrücklicher
                    Einwilligung der betroffenen Person, trifft TeamSpark angemessene Maßnahmen, um die Rechte
                    und Freiheiten sowie die berechtigten Interessen der betroffenen Person zu wahren, wozu mindestens
                    das Recht auf Erwirkung des Eingreifens einer Person seitens des Verantwortlichen, auf Darlegung des
                    eigenen Standpunkts und auf Anfechtung der Entscheidung gehört.</p>

                <p class="mt-2">Möchte die betroffene Person Rechte mit Bezug auf automatisierte Entscheidungen geltend
                    machen, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
                    Verantwortlichen wenden.</p>

            </li>
            <li><h4 class="text-lg mt-4 text-primary">i)      Recht auf Widerruf einer datenschutzrechtlichen
                    Einwilligung</h4>
                <p class="mt-2">Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
                ...
                <p class="mt-2">Möchte die betroffene Person ihr Recht auf Widerruf einer Einwilligung geltend machen,
                    kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
                    wenden.</p>

            </li>
        </ul>
        <h4 class="text-lg mt-4 text-primary">10. Datenschutzbestimmungen zu Einsatz und Verwendung von Google Analytics
            (mit
            Anonymisierungsfunktion)</h4>
        <p class="mt-2">Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite die Komponente Google
        ...
        <p class="mt-2">Betreibergesellschaft der Google-Analytics-Komponente ist die Google Ireland Limited, Gordon
            House, Barrow Street, Dublin, D04 E5W5, Ireland.</p>

        <p class="mt-2">Der für die Verarbeitung Verantwortliche verwendet für die Web-Analyse über Google Analytics den
        ...
        <p class="mt-2">Der Zweck der Google-Analytics-Komponente ist die Analyse der Besucherströme auf unserer
        ...
        <p class="mt-2">Google Analytics setzt ein Cookie auf dem informationstechnologischen System der betroffenen
        ...
        <p class="mt-2">Mittels des Cookies werden personenbezogene Informationen, beispielsweise die Zugriffszeit, der
        ...
        <p class="mt-2">Die betroffene Person kann die Setzung von Cookies durch unsere Internetseite, wie oben bereits
            dargestellt, jederzeit mittels einer entsprechenden Einstellung des genutzten Internetbrowsers verhindern
            und damit der Setzung von Cookies dauerhaft widersprechen. Eine solche Einstellung des genutzten
        ...
        <p class="mt-2">Ferner besteht für die betroffene Person die Möglichkeit, einer Erfassung der durch Google
        ...
        <p class="mt-2">Weitere Informationen und die geltenden Datenschutzbestimmungen von Google können unter
        ...
        <h4 class="text-lg mt-4 text-primary">11. Rechtsgrundlage der Verarbeitung</h4>
        <p class="mt-2">Art. 6 I lit. a DS-GVO dient unserem Unternehmen als Rechtsgrundlage für Verarbeitungsvorgänge,
            ...
            müssten. Dann würde die Verarbeitung auf Art. 6 I lit. d DS-GVO beruhen.
        ...
        <h4 class="text-lg mt-4 text-primary">12. Berechtigte Interessen an der Verarbeitung, die von dem
            Verantwortlichen oder einem
            Dritten verfolgt werden</h4>
        <p class="mt-2">Basiert die Verarbeitung personenbezogener Daten auf Artikel 6 I lit. f DS-GVO ist unser
        ...
        <h4 class="text-lg mt-4 text-primary">13. Dauer, für die die personenbezogenen Daten gespeichert werden</h4>
        <p class="mt-2">Das Kriterium für die Dauer der Speicherung von personenbezogenen Daten ist die jeweilige
        ...
        <h4 class="text-lg mt-4 text-primary">14. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der
            personenbezogenen
        ...
        <p class="mt-2">Wir klären Sie darüber auf, dass die Bereitstellung personenbezogener Daten zum Teil gesetzlich
        ...
        <h4 class="text-lg mt-4 text-primary">15. Bestehen einer automatisierten Entscheidungsfindung</h4>
        <p class="mt-2">Als verantwortungsbewusstes Unternehmen verzichten wir auf eine automatische
            Entscheidungsfindung oder ein Profiling.</p>

        <p class="mt-2">Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche
            Gesellschaft für Datenschutz GmbH, die <a
                href="https://dg-datenschutz.de/datenschutz-dienstleistungen/datenschutz-audit/">Datenschutz Audits</a>
            durchführt, in Kooperation mit der <a href="https://www.wbs-law.de/taetigkeitsgebiete/medienrecht/">Medienrechtskanzlei
                WILDE BEUGER SOLMECKE</a> erstellt.
        </p>
    </div>
@endsection
